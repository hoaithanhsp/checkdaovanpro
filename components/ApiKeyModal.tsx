...
const MODELS = [
    { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', description: 'Ổn định và đáng tin cậy', default: true },
    { id: 'gemini-2.0-flash', name: 'Gemini 2.0 Flash', description: 'Nhanh và hiệu quả' },
    { id: 'gemini-1.5-pro', name: 'Gemini 1.5 Pro', description: 'Mạnh mẽ và chi tiết' },
];
